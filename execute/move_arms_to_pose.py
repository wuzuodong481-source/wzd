...
# -*- coding: utf-8 -*-
"""
move_arms_to_pose.py — 双臂运动到 JSON 文件记录的关节位姿 (模板)

使用方法:
  1. 修改下方 POSE_FILE 为要调用的位姿 JSON 文件路径
  2. 运行: python move_arms_to_pose.py
...
#  ★ 可替换路径 - 调用的位姿 JSON 文件 ★
# ═══════════════════════════════════════════════════════════
POSE_FILE = "/data/wzd/position/pose_20260810_134903.json"
# ═══════════════════════════════════════════════════════════
...
def main():
    parser = argparse.ArgumentParser(description="双臂运动到 JSON 记录的位姿 (模板)")
